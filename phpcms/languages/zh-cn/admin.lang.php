...
//index
$LANG['admin_site_title'] = '绿色在线 - 后台管理中心';
$LANG['expand_or_contract'] = '展开与收缩';
$LANG['phpcms_title'] = '绿色在线内容管理系统';
...
$LANG['main_safety_permissions'] = '※ 强烈建议您将（绿色在线）目录设置为644（linux/unix）或只读（NT）';
