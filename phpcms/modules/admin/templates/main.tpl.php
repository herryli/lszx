...
<div class="col-2 col-auto">
	...
	<div class="content">
	<?php echo L('main_version')?>绿色在线 <?php echo PC_VERSION?>  Release <?php echo PC_RELEASE?> <!--  [<a href="http://download.phpcms.cn" target="_blank"><?php echo L('main_latest_version')?></a>]--><br />
