...
class attachments {
	...
	public function swfupload(){
		...
		if(isset($_POST['dosubmit'])){
			...
			if($fileext == 'rar' || $fileext == 'zip' || $fileext == 'doc' || $fileext == 'docx' ||
					$fileext == 'xls' || $fileext == 'xlsx' || $fileext == 'ppt' || $fileext == 'pptx'||
					$fileext == 'flv' || $fileext == 'swf' || $fileext == 'rm' || $fileext == 'rmvb')
			{
                                //file_put_contents('a.txt',var_export($_FILES,true),FILE_APPEND);
				pc_base::load_app_class('oss','oss');
				$oss = new oss();
				$oss->upload();
				exit;
			}
