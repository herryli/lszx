...
//个人测试
//ACCESS_ID
define('OSS_ACCESS_ID', 'iHHtkEpdYMLtyouS');

//ACCESS_KEY
define('OSS_ACCESS_KEY', 'uUwE0bG4vwqZhcVqzCvTIfooqlE0rh');
...
require_once PC_PATH.'modules'.DIRECTORY_SEPARATOR.'oss'.DIRECTORY_SEPARATOR.'classes'.DIRECTORY_SEPARATOR.'requestcore.class.php';
//加载MimeTypes
//require_once OSS_API_PATH.DIRECTORY_SEPARATOR.'util'.DIRECTORY_SEPARATOR.'mimetypes.class.php';
require_once PC_PATH.'modules'.DIRECTORY_SEPARATOR.'oss'.DIRECTORY_SEPARATOR.'classes'.DIRECTORY_SEPARATOR.'mimetypes.class.php';

//检测语言包
if(file_exists(PC_PATH.'languages'.DIRECTORY_SEPARATOR.'zh-cn'.DIRECTORY_SEPARATOR.'zh.inc.php')){
	//require_once OSS_API_PATH.DIRECTORY_SEPARATOR.'lang'.DIRECTORY_SEPARATOR.ALI_LANG.'.inc.php';
	require_once PC_PATH.'languages'.DIRECTORY_SEPARATOR.'zh-cn'.DIRECTORY_SEPARATOR.'zh.inc.php';
}else{
...
class alioss{
	...
	public function upload_file_by_file($bucket,$object,$file,$options = NULL){
		...
		//file_put_contents('a.txt', var_export($file,true),FILE_APPEND);
