...
function doStart() {
	if (cmsAD_45.Scroll=='Y') {
		setInterval("heartBeat(\""+cmsAD_45.PosID+"\")",10);
	}
}
...
cmsAD_45.ADName = "首页对联广告5"; 
cmsAD_45.ADContent = "{'Images':[ {'imgADLinkUrl':'http%3A%2F%2Fclmmc.cdylw.com','imgADAlt':'垫江县丛林苗木场','ImgPath':'http://121.199.44.61/lszx/uploadfile/2013/1008/20131008074558442.gif'}, {'imgADLinkUrl':'http%3A%2F%2Fcdylw.com','imgADAlt':'','ImgPath':'http://121.199.44.61/lszx/uploadfile/2013/1008/20131008075731109.jpg'},],'imgADLinkTarget':'New','Count':'2','showAlt':'Y'}"; 
cmsAD_45.URL = "http://www.cdylw.com/lszx/index.php?m=poster&c=index"; 
cmsAD_45.SiteID = 1; 
cmsAD_45.PaddingLeft = 0; 
cmsAD_45.PaddingTop =  426 ; 
cmsAD_45.Scroll = 'Y'; 
cmsAD_45.Width = 100; 
cmsAD_45.Height = 100; 
